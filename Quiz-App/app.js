...
const array = [
	...
	},
	{
		...
		options:["JavaScript Oriented Notation ", " JavaScript Object Notation ", " Java Ordered Notation ", "Java Object Notation "],
		correct:1
	},
	{
		Q:"7. How do you represent data in JSON? ",
		options:[" Key-Value pairs ", "Metadata ", "Binary Data ", "Key-Object pairs "],
		correct:0
	},
	{
		Q:"8. Which data structure is based on the Last-In-First-Out (LIFO) principle? ",
		options:["Queue ", "Stack", " Tree ", "Linked list"],
		correct:1
	},
	{
		Q:"9. Which data structure stores elements in non-contiguous memory locations? ",
		options:["Array", " Stack ", "Linked list", "Binary Search Tree"],
		correct:2
	},
	{
		Q:"10. Which device is primarily used to link two or more separate networks?",
